...
<h1 id="о-синхронизации-потоков-через-субд"><em>О синхронизации потоков через СУБД</em></h1>
...
<p>Тут все очень просто: многие БД предоставляют доступ к инструментам блокировки строк и таблиц, например [<a href="https://www.postgresql.org/docs/9.1/explicit-locking.html">postgres предоставляет  семантику select for update</a>](<a href="https://www.postgresql.org/docs/9.1/explicit-locking.html">https://www.postgresql.org/docs/9.1/explicit-locking.html</a>)</p>
